...
def client(s):
	...
	with lock:
		...
		users[p][p] = s
		#Control AQUI
		s.send(("Bienvenido " + nick + ".\nEn este juego de ajedrez, las piezas azules coresponden a las blancas y las rojas a las negras.\nPara hacer un movimiento debes introducir por ejemplo: 7d6d. Donde '7d' corresponde a las coordenadas de origen de la pieza, y 6d las coordenadas de destino. Si introduces ff te rendiras. El color de tus piezas es: " + color + "\n¡SUERTE!\n").encode("UTF-8"))
